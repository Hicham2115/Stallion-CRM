...
function Block({ className }) {
    return (<div className={`deck-inset animate-pulse rounded-2xl border border-hairline bg-deck-surface ${className ?? ""}`}/>);
}
export default function AdminDashboardLoading() {
    return (<PageShell aria-busy aria-label={consoleConfig.content.loadingLabel}>

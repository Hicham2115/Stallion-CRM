...
export const metadata = {
    title: "Dashboard",
    description: "Pipeline overview for the Stallion Advertising sales team — clients, attending rate, conversion and rep performance.",
};
...
export default function AdminDashboardPage() {
    return (<PageShell>
      ...
      {(features.pipelineBreakdown || features.clientStatus) && (<div className="grid grid-cols-1 gap-5 lg:grid-cols-12">
          {features.pipelineBreakdown && (<div className="lg:col-span-7 xl:col-span-8">
              <PipelineBreakdown />
            </div>)}
          {features.clientStatus && (<div className="lg:col-span-5 xl:col-span-4">
              <ClientStatus />
            </div>)}
        </div>)}

...
export default function NotFound() {
  return (
    ...
    >
      <div className="reveal-card deck-lift relative flex max-w-md flex-col items-center gap-5 rounded-md border border-hairline bg-deck-card/85 px-8 py-12 text-center backdrop-blur-xl">

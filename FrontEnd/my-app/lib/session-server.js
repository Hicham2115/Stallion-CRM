...
import { SESSION_CLIENT_COOKIE, SESSION_REP_COOKIE, SESSION_ROLE_COOKIE, parseSession, } from "@/lib/session";
/**
...
export async function readSession() {
    ...
    return parseSession(store.get(SESSION_ROLE_COOKIE)?.value, store.get(SESSION_CLIENT_COOKIE)?.value, store.get(SESSION_REP_COOKIE)?.value);
}

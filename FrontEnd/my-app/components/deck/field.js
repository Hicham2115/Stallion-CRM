...
export const fieldAlert = "flex items-start gap-2.5 rounded-md border border-status-critical/28 bg-status-critical/10 px-3.5 py-3 text-[0.8125rem] leading-relaxed text-status-critical";

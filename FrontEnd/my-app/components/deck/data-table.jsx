...
export function DataRow(_a) {
  var { interactive = false, className } = _a,
    props = __rest(_a, ["interactive", "className"]);
  return (
    <tr
      className={cn(
...
export function DataCell(_a) {
  var { numeric = false, sticky = false, className } = _a,
    props = __rest(_a, ["numeric", "sticky", "className"]);
  return (
    <td
      className={cn(
        cellPadding,

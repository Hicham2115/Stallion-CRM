...
export function WarningChip({ icon: Icon, label, title, className, }) {
    return (<span title={title} className={cn("inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border px-2.5 py-1 font-mono text-[0.625rem] uppercase tracking-[0.18em]", "border-status-warning/28 bg-status-warning/10 text-status-warning", className)}>

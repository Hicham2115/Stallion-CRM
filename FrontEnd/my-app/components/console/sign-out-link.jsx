...
//
// TODO(backend): call your provider's signOut() / DELETE /api/session and
// let the server expire the httpOnly cookie — clearPreviewSession() goes
// away with the preview build.

...
/**
 * Shown when a lead id does not resolve — a deleted record, or a stale
 * bookmark someone kept.
 *
 * Scoped to this route segment rather than relying on the app-wide 404, so the
 * page keeps the console shell around it: the sidebar, the topbar and a way
 * back to Clients. A bare full-page 404 would drop the user out of the console
 * entirely and make a mistyped id look like the app had crashed.
 */
